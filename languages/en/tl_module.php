 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_module']['BgSlider_slideTime']			= array('Transition time','Time in milliseconds for the fade effect.');
$GLOBALS['TL_LANG']['tl_module']['BgSlider_waitTime']			= array('Wait time','Time in milliseconds between the effects.');
